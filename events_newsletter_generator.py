...
RULES:
- Include ALL articles marked [MUST INCLUDE] — do not skip any
- Also include articles marked [PRIORITIZE]
- For DEALS: Only include M&A directly related to media, events, exhibitions, conferences, or trade publishers
